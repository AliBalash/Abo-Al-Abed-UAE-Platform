...
const extraMenuSeeds = ([
    ...
    categorySlug,
    featured: index < 4,
    imageUrl: aboAlAbedImageUrls[index % aboAlAbedImageUrls.length],
    ...
    data: [
      {
        ...
        imageUrl: "/assets/menu/abo-menu-1.jpg",
      ...
      },
      {
        ...
        imageUrl: "/assets/menu/abo-menu-2.jpg",
