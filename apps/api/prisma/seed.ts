...
async function main() {
  ...
  const roleMap = {
    ...
    kitchen_manager: ["orders.read", "orders.manage", "catalog.manage", "branches.manage", "reports.read", "audit.read"],
    ...
    data: [
      {
        ...
        subtitleAr: "عرض حار للاستلام السريع.",
        imageUrl: "/assets/banners/hareeq-offer-slider.jpg",
        ctaLabelEn: "View Offer",
        ctaLabelAr: "شاهد العرض",
        ctaTarget: "/menu",
        theme: "top_strip",
        displayOrder: 1,
      },
      {
        ...
        titleAr: "بوكس تغميسات",
        subtitleEn: "Sharing box offer for groups.",
        subtitleAr: "عرض بوكس مشاركة للمجموعات.",
        imageUrl: "/assets/banners/taghmisat-offer-slider.jpg",
        ctaLabelEn: "View Offer",
        ctaLabelAr: "شاهد العرض",
        ctaTarget: "/menu",
        theme: "top_strip",
      ...
      },
      {
        ...
        subtitleAr: "عرض عائلي بقيمة كبيرة.",
        imageUrl: "/assets/banners/baby-satl-offer-slider.jpg",
        ctaLabelEn: "View Offer",
        ctaLabelAr: "شاهد العرض",
        ctaTarget: "/menu",
        theme: "top_strip",
      ...
      {
        titleEn: "30% App Deal",
        titleAr: "خصم 30٪ للتطبيق",
        subtitleEn: "Order from app and save on pickup.",
        subtitleAr: "اطلب من التطبيق ووفر في الاستلام.",
        imageUrl: "/assets/banners/app-deal-30.gif",
        ctaLabelEn: "Use Deal",
        ctaLabelAr: "استخدم العرض",
        ctaTarget: "/menu",
